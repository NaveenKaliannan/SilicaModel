...
const double Temp     = 2000;         //Temperature of the system  = 2000 K (in kelvin)
const double Pr       = 0.6023 * 100; //Pressure of the system, Now it is 100 GPa
...
// Short-range interactions using Morse Potential
